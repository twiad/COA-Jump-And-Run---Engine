...
//#else
//	typedef stdext::hash_map<Ogre::Material*, SBMaterialRef*> SBMaterialRefList;
//#endif
...
public:
	...
	*/
	inline void createBillboard(const Ogre::Vector3 &position, float xScale = 1.0f, float yScale = 1.0f, Ogre::uint16 texcoordIndexU = 0, Ogre::uint16 texcoordIndexV = 0)
	{
